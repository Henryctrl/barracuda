...
import { Layers, FileText, Home } from 'lucide-react';
...
export default function HunterPage() {
  // State to manage which view (Cadastre or DPE) is active
  const [activeView, setActiveView] = useState<'cadastre' | 'dpe'>('cadastre');
