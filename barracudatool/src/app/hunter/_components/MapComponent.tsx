...
<div className="absolute top-4 right-4 z-10">
        ...
        <button
          ...
          className="px-4 py-2 bg-container-bg border-2 border-accent-cyan text-accent-cyan rounded-md font-bold hover:bg-accent-yellow hover:text-background-light transition-all shadow-glow-cyan backdrop-blur-sm bg-background-dark/75"
        >
