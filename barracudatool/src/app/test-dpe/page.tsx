 'use client'
  ...
  export default function TestDPE() {
    ...
    // Added: Test your known certificate and coordinates on page load
    useEffect(() => {
      console.log('🎯 Testing your specific DPE certificate...');
      DpeAPI.getDpeByCertificateNumber('2524E2351120U').then(result => {
        console.log('Your DPE:', result);
      });
  
      console.log('🎯 Testing by coordinates...');
      DpeAPI.getDpeNearCoordinates(0.476737, 44.803428).then(results => {
        console.log('Found DPEs:', results);
      });
    }, []); // Empty array means it runs once on page load
            ...
            <div className="text-white text-sm space-y-3">
              ...
              <div className="bg-orange-900/20 p-3 rounded border border-orange-500/30 mt-4">
                ...
                <ul className="list-disc list-inside mt-2 space-y-1 text-xs">
                  ...
                  <li>Property address doesn't match BAN (Base Adresse Nationale) format</li>
